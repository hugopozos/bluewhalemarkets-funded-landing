export default function Hero() {
  ...
  }} className="bg-white text-black hover:bg-gray-100 rounded-full px-10 py-3 font-medium text-base transition flex items-center gap-2 mx-auto relative overflow-hidden group">
